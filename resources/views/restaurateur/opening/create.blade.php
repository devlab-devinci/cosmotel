...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header mb-3">Register your restaurant openings day and hour</div>
                        ...
                        @foreach($days as $day)
                            ...
                            <div class="form-group row">
                                ...
                                @foreach($times as $time)
                                    ...
                                    <div class="col-md-1">
                                        <input id="{{ $day->label }}_{{ $time }}" type="checkbox" checked class="form-control{{ $errors->has($day->label . '_' . $time) ? ' is-invalid' : '' }}" name="days[{{ $day->index }}][open_{{ $time }}]" autofocus>
                                    ...
                                    <div class="col-md-2">
                                        <input id="{{ $day->label }}_{{ $time }}-open" @if($time === "morning") value="06:00" @elseif ($time === "lunch") value="12:00" @else value="19:00" @endif type="time" class="form-control{{ $errors->has($day->label . '_' . $time . '-open') ? ' is-invalid' : '' }}" name="days[{{ $day->index }}][open_time_{{ $time }}]" autofocus>
